# Enabling AWS Cost and Usage Reports (CUR) with Terraform ![](https://img.shields.io/github/actions/workflow/status/wearetechnative/terraform-aws-quicksight-source/lint.yaml?branch=main&style=plastic&label=lint) ![](https://img.shields.io/github/actions/workflow/status/wearetechnative/terraform-aws-quicksight-source/security-scan.yaml?branch=main&style=plastic&label=security)
